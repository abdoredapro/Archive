    ...
    <ul>
        ...
        @can('category.view')
            <li class="{{ Route::is('dashboard.category.*') ? 'active' : '' }}">
                <a class="stack {{ Route::is('dashboard.category.*') ? 'active' : '' }}" href="{{ route('dashboard.category.index') }}">
        ...
        <li class="{{ Route::is('dashboard.file.*') ? 'active' : '' }}">
            <a class="stack {{ Route::is('dashboard.file.*') ? 'active' : '' }}" href="{{ route('dashboard.file.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5">
        ...
        <li class="{{ Route::is('dashboard.film.*') ? 'active' : '' }}">
            <a class="stack {{ Route::is('dashboard.film.*') ? 'active' : '' }}" href="{{ route('dashboard.film.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
        ...
        <li class="{{ Route::is('dashboard.projects.*') ? 'active' : '' }}">
            <a class="stack {{ Route::is('dashboard.projects.*') ? 'active' : '' }}" href="{{ route('dashboard.projects.index') }}">
