document.addEventListener("DOMContentLoaded", function () {
  ...
  var data = [];
  // var data = [
  //   { activity: "أخرى", views: 32 },
  //   { activity: "إعداد", views: 15 },
  //   { activity: "فعاليات", views: 22 },
  //   { activity: "مواسم الحج", views: 30 },
  //   { activity: "مقتاس", views: 20 },
  //   { activity: "أفلام", views: 18 },
  //   { activity: "برامج تليفزيون", views: 27 },
  // ];
